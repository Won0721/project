...
CREATE TABLE `verification` (
  `ve_email` varchar(45) NOT NULL,
  `ve_verification` varchar(45) DEFAULT NULL,
...
INSERT INTO `verification` VALUES ('heenmilk@naver.com','123456'),('security@naver.com','123456');
