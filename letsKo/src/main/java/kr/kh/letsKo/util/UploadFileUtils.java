...
public class UploadFileUtils {
	...
	public static String uploadFile(String uploadPath, String originalFileName, byte[] fileData) throws IOException {
		...
		String[] folderPath = uploadPath.split("\\\\");
		return uploadFileName(File.separator+folderPath[2]+savedPath, savedFileName);
	}
	...
	public static void deleteFile(String uploadPath, String cf_name) {
		File file = new File(uploadPath+cf_name);
		if(file.exists()) {
			file.delete();
		}
	}
